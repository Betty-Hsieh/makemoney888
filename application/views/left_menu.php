        ...
        <div class="media user-media bg-dark dker">
          ...
          <div class="user-wrapper bg-dark">
            <a class="user-link" href="">
              <img class="media-object img-thumbnail user-img" alt="User Picture" src="<?php echo URL_IMG; ?>user.gif">
        ...
        <ul id="menu" class="bg-blue dker">
            ...
            <ul>
              <li>
                <a href="<?php echo URL; ?>member">
                  <i class="fa fa-angle-right"></i>&nbsp; Member</a> 
              </li>
              <li>
                <a href="<?php echo URL; ?>member/add_member_page">
                  <i class="fa fa-angle-right"></i>&nbsp; Add Member</a> 
              </li>
            </ul>
          </li>
          <li class="">
            ...
            <ul>
              <li>
                <a href="<?php echo URL; ?>epaper/epaper_edit_page">
                  <i class="fa fa-angle-right"></i>&nbsp; Epaper edit</a> 
              </li>
              <li>
                <a href="<?php echo URL; ?>epaper">
                  <i class="fa fa-angle-right"></i>&nbsp; Epaper list</a> 
              </li>
            </ul>
          </li>
          <li class="">
          ...
          <li class="">
            ...
            <ul>
              ...
              <li>
                <a href="<?php echo URL; ?>form_validation">
