                  ...
                  <div id="collapse2" class="body">
                    <form class="form-horizontal" action="add_product" method="post" enctype="multipart/form-data">
                      <div class="form-group">
                        <label class=" col-lg-12">product_title</label>
                        <div class="col-lg-12">
                          <input type="text" class="validate[required] form-control" name="product_title" id="req">
                        </div>
                      </div>
                       <div class="form-group">
                        <label class=" col-lg-12">product_price</label>
                        <div class="col-lg-12">
                          <input type="text" class="validate[required] form-control" name="product_price" id="req">
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-lg-12">product_content</label>
                        <div class=" col-lg-12">
                          <textarea  class="validate[required] form-control ckeditor" name="product_content" id="req ckeditor" /></textarea>
                        </div>
                      </div>
                      <div class="form-group">
                        <label class="col-lg-2">product_img</label>
                        <div class=" col-lg-10">
