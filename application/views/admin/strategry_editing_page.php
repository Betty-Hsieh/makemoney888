          ...
          <div class="row">
            <div class="col-md-12">
              <div class="box box-info">
                ...
                <form id="strategry" action="/manager/SaleStrategery/editing_strategery" class="form-horizontal" method="post"  enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                      ...
                      <div class="col-sm-6">
                        <input type="text" class="form-control" name="title" value="<?php echo $row['title'];?>" placeholder="組合銷售名稱"/>
                      </div>
                    </div>
                    <!--
                    <div class="form-group">
                        ...
                        <table class="table table-bordered">
                            ...
                            <tfoot>
                                <tr>
                                    <td colspan="3">
                                        組合促銷價格&nbsp;:&nbsp;
                                        <input type='text' name='price' value='<?php echo $discount_price;?>'/>
                                    </td>
                                </tr>
                                <tr>
                                    <td colspan="3">
                                ...
                                <tr>
                                    <td colspan="3">
                                        ...
                                        <button type="submit" class="btn btn-primary ">確認組合促銷方案</button>
