...
?>			  
                <form action="/manager/Discount/editing_discount" class="form-horizontal" method="post" enctype="multipart/form-data">
...
?>
                    <br />
                    <button type="submit" class="btn btn-primary">編輯折扣</button>
