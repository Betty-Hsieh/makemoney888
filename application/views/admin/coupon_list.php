              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table id="example1" class="table table-bordered table-striped">
                  	<caption>
                    	<button type="button" class="btn btn-success" onClick="location.href='/manager/Course/adding_course_page'">建立折價卷</button>
                    </caption>
                    <thead>
                      <tr>
                        <th>編號</th>
                    ...
                    <tbody>
                      <?php 
						  foreach($course as $key => $row){ 
							  ...
							  echo "<td><a href='/manager/Course/applicant'>".$row->product_title."</a></td>";
							  ...
							  echo "<td><button type='button' class='btn btn-default' onclick=location.href='/manager/Course/delete_course/".$row->uniqid_id."'>刪除</button></td>";
							  echo "</tr>";
						  }
					  ?>
                    </tbody>
...
$(function(){
	delete_member=function(id){
		if(confirm("確定刪除此折價卷嗎?")){
		   $.ajax({
			  method: "POST",
			  url: "/manager/Coupon/delete_coupon/"+id,
			  data:{
				  id:id
			  }
