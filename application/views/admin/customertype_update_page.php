...
?>			  
                <form action="/manager/CustomerType/edit_customertype" class="form-horizontal" method="post" enctype="multipart/form-data">
...
?>
                    <br />
                    <button type="submit" class="btn btn-primary">編輯會員分類</button>
