              ...
              <div class="box">
                ...
                <div class="box-body">
                  <table class="table table-bordered table-striped data_table">
                  	<caption>
                        <!--
                    	<button type="button" class="btn btn-success" onClick="location.href='/manager/Discount/discount_adding_page'">建立折扣管理</button>
                        -->
                    </caption>
                    <thead>
                      <tr>
...
foreach ($shipping as $key => $row) {
    ...
    echo "<td><button type='button' class='btn btn-sm btn-success' onclick=location.href='/manager/Discount/discount_editing_page/".$row->kv . "'>編輯</button></td>";
    echo "</tr>";
}
?>
                    </tbody>
